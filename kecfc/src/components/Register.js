...
function Register() {
    ...
    return (
        <form className="form1" onSubmit={registerMe}>
            ...
            <label htmlFor="address" className="form-label m-2 h5">Name</label>
                 <input type="text" name="addr" placeholder="Name" className="form-control" value={user.addr} onChange={changeMe} required/></div>
