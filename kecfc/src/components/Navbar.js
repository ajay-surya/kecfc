...
function Navbar() {
  //console.log("navbar rendered");
    ...
    <Link to="/" className="navbar-brand">
      <img id="nav-logo" src="./assets/icons8-food-app-65.png" alt="nav-logo" className="img-fluid d-inline-block align-baseline me-2" />
      <span className="nav-title">KEC</span><span className="nav-title-to">FC</span>
    </Link>
