...
function Footer() {
  ...
  <footer className="d-flex flex-wrap align-items-center py-2">
    <p className="col-md-4 mb-0 text-light flex-fill">&copy; KEC</p>
 ...
 <div className="offcanvas-body px-3">
   <hr/>
   <div>
   OUR website is to serve the students and faculty of kongu Engineering college. Through this website we can Order food and snacks from our college FC .  
   </div>
  <hr/>
  ...
  <Link to="/contact"><button type="button" className="btn btn-outline-primary btn-sm rounded-pill m-2 mx-1" data-bs-toggle="offcanvas" data-bs-keyboard="true" data-bs-target="#offerModal">Offers</button></Link>
  </div>
 </div>
</div>
<OfferModal />
